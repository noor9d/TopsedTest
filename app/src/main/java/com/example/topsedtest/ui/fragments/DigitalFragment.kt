...
import com.example.topsedtest.databinding.FragmentDigitalBinding
...
class DigitalFragment : Fragment() {
    ...
    private lateinit var viewBinding: FragmentDigitalBinding
    ...
    override fun onCreateView(
        ...
        viewBinding = FragmentDigitalBinding.inflate(inflater, container, false)
...
//        viewBinding.arcProgress.textColor = defaultTextView.currentTextColor
    ...
    private fun setDashboardStatus(dashboardData: DashboardData) {
        ...
        viewBinding.currentSpeed.text = "${dashboardData.getCurrentSpeed()}"
...
//        viewBinding.topSpeedUnitText.text = speedUnitText
        viewBinding.currentSpeedUnit.text = speedUnitText
    }
...
//                viewBinding.topSpeedText.startAnimation(anim)
    ...
    companion object {
       const val TAG = "DigitalFragment1"
    }
}