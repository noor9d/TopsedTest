package com.example.topsedtest.customs.speedyview
...
class SpeedyView @JvmOverloads constructor(
    ...
    private val metricTextView = TextView(getContext()).apply {
        setTextAppearance(com.google.android.material.R.style.TextAppearance_AppCompat_Caption)
    }

    private val timerTextView = TextView(getContext()).apply {
        setTextAppearance(com.google.android.material.R.style.TextAppearance_AppCompat_Subhead)
    }
    ...
    private fun getColorBasedOnPercentage(percentage: Double): Int {
        ...
        return when {
            ...
            percentage < 0.7 -> {
                val startColor = ContextCompat.getColor(context, R.color.purple_500)
